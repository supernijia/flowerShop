...
let titleJsons = {};
statConfig.appid = "__UNI__EC81B5A";
titleJsons = { "pages/index/index": "Flower Taste", "pages/classification/classification": "\u5206\u7C7B", "pages/shop/shop": "\u5546\u94FA", "pages/test/test": "\u6D4B\u8BD5\u9875", "pages/cart/cart": "\u8D2D\u7269\u8F66", "pages/mine/mine": "\u4E2A\u4EBA\u9875", "pages/settlement/settlement": "\u7ED3\u7B97\u9875", "pages/details/details": "\u5546\u54C1\u8BE6\u60C5\u9875", "pages/userAddress/userAddress": "\u6536\u8D27\u5730\u5740", "pages/newAddress/newAddress": "\u589E\u52A0\u65B0\u5730\u5740", "pages/delivery/delivery": "\u5F85\u53D1\u8D27\u8BA2\u5355" };
...
let data = index.getStorageSync("$$STAT__DBDATA") || {};
const dbSet = (name, value) => {
  if (!data) {
    data = {};
  }
  data[name] = value;
  index.setStorageSync("$$STAT__DBDATA", data);
};
const dbGet = (name) => {
  if (!data[name]) {
    let dbdata = index.getStorageSync("$$STAT__DBDATA");
    if (!dbdata) {
      dbdata = {};
    }
    if (!dbdata[name]) {
...
const dbRemove = (name) => {
  if (data[name]) {
    ...
    data = index.getStorageSync("$$STAT__DBDATA");
    if (data[name]) {
      delete data[name];
      index.setStorageSync("$$STAT__DBDATA", data);
    }
